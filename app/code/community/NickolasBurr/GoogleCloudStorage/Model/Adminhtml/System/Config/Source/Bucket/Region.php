...
class NickolasBurr_GoogleCloudStorage_Model_Adminhtml_System_Config_Source_Bucket_Region
{
    /**
    ...
    {
        return Mage::helper(NickolasBurr_GoogleCloudStorage_Helper_Dict::XML_PATH_HELPER_STORAGE)->getRegions();
    }
}
